...
This document contains the structural blueprint and initial draft for the custom 16-bit Instruction Set Architechture (ISA) designed for **Project 816_NOT**. 

---
## 1. **Architectural Foundation**
   -**Word Size:** 16-bit instruction word budget
   -**Data Width:** 16-bit wide internal registers and data pathways
   -**Addressable Memory:** 16-bit base pointers allow access up to **2<sup>16</sup> = 65,536 unique memory locations (64 KB RAM)**
...
| **ALU** | `ADD` | `00001` | `ADD R1, R2, R3` | $R_1 = R_2 + R_3$ |
| **ALU** | `SUB` | `00010` | `SUB R1, R2, R3` | $R_1 = R_2 - R_3$ |
| **ALU** | `AND` | `00011` | `AND R1, R2, R3` | $(R_1 = R_2 \ \& \ R_3$) |
| **ALU** | `OR`  | `00100` | `OR R1, R2, R3` | $(R_1 = R_2 \ \Vert{} \ R_3$) |
| **ALU** | `XOR` | `00101` | `XOR R1, R2, R3` |$(R_1 = R_2 \oplus R_3$) |
| **ALU** | `SLT` | `00110` | `SLT R1, R2, R3` | $(R_1 = (R_2 < R_3)  ? 1: 0$) |
| **ALU** | `SLL` | `00111` | `SLL R1, R2, R3` | $(R_1 = R_2 << R_3$) |
| **ALU** | `SRL` | `01000` | `SRL R1, R2, R3` | $(R_1 = R_2 >> R_3$) |
| **Imm** | `ADDI` | `01001` | `ADDI R1, R2, 1` | $R_1 = R_2 + Imm_5$ |
| **Imm** | `ANDI` | `01010` | `ANDI R1, R2, 2` | $R_1 = R_2\ \&\ Imm_5$ |
| **Imm** | `ORI`  | `01011` | `ORI R1, R2, 3` | $R_1 = R_2 \ \|\ Imm_5$ |
| **Mem** | `LW`   | `01100` | `LW R1, 4(R2)` | $R_1 = Memory[R_2 + 4]$ |
| **Mem** | `SW`   | `01101` | `SW R1, 4(R2)` | $Memory[R_2 + 4] = R_1$ |
| **Mem** | `LUI`  | `01110` | `LUI R1, 0x4F` | $R_1 = {Imm_8,\ 8'b0}$ |
| **Ctrl**| `BEQ`  | `01111` | `BEQ R1, R2, 10` | if $(R_1== R_2) \\PC = PC + Imm_5$ |
| **Ctrl**| `BNE`  | `10000` | `BNE R1, R2, 10` | if $(R_1 != R_2) \\PC = PC + Imm_5$ |
| **Ctrl**| `J`    | `10001` | `J 0x03FF` | $PC = JumpAddress_{11}$ |
| **Ctrl**| `JAL`  | `10010` | `JAL 0x03FF` | $R_7 = PC + 1; PC = JumpAddress_{11}$ |
